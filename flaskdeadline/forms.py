...
from wtforms import StringField, PasswordField, SubmitField, BooleanField, DateTimeField, SelectField, IntegerField, DecimalField
...
class ModuleForm(FlaskForm):
    ...
    breakdown = IntegerField('% of Module (Out of 100%)',default=20, validators=[DataRequired(),NumberRange(min=0,max=35)])
