...
module_1 = Module(id='ELEC60004', title ='Artificial Intelligence')
module_2 = Module(id='ELEC60005', title ='Biomedical Electronics')
module_3 = Module(id = 'ELEC60013', title = 'Embedded Systems')
module_4 = Module(id='ELEC60006', title ='Communication Networks')
module_5 = Module(id='ELEC60007', title ='Communication Systems')
module_6 = Module(id = 'ELEC60008', title = 'Control Engineering')
module_7 = Module(id = 'ELEC60010', title = 'Digital Signal Processing')
...
module_4.gta_responsible.append(student_1)
